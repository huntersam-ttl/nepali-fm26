...
const ownerEvent = (event: HistoricalEvent): boolean =>
  ...
  /(OWNERSHIP|INVESTOR|TAKEOVER|CAPITAL|SPONSOR|COMMERCIAL|FACILITY|STADIUM|DEBT|DEFAULT|MANAGER_APPOINT|MANAGER_DISMISS|STAFF_APPOINT|TRANSFER|LOAN|PROMOTION|RELEGATION|TROPHY|CHAMPION|PROTEST)/i.test(
    event.eventType,
  );
