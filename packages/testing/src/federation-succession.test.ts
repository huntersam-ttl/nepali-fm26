...
describe("federation leadership continuity", () => {
  it("produces three recurring administrations with interim and persisted authority", () => {
    ...
    const results = [
      ...ensureFederationLeadershipContinuity(db, { date: "2026-10-28", seed: "federation-succession" }),
      ...ensureFederationLeadershipContinuity(db, { date: "2031-01-28", seed: "federation-succession" }),
      ...ensureFederationLeadershipContinuity(db, { date: "2035-08-28", seed: "federation-succession" }),
      ...ensureFederationLeadershipContinuity(db, { date: "2035-11-28", seed: "federation-succession" }),
      ...ensureFederationLeadershipContinuity(db, { date: "2036-02-28", seed: "federation-succession" }),
    ];
    ...
    expect(ensureFederationLeadershipContinuity(db, { date: "2036-02-28", seed: "federation-succession" })).toHaveLength(0);
