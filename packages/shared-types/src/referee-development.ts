...
import type { RefereeGovernanceSummary } from "./federation-strategy.js";
 ...
 * President — real assignment/match-event-derived governance signals plus
 * the real referee pool size and active development programme count. */
export type FederationRefereeContext = {
  governance: RefereeGovernanceSummary;
  poolSize: number;
  activeDevelopmentProgrammes: number;
