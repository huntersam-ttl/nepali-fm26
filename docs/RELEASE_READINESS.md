...
| Performance                   | FAIL_PERFORMANCE | Controlled three-season revalidation passed correctness: S1/S2/S3 were 221.70s/262.42s/503.34s (987.46s cumulative), with 0 structural shortages and 0 emergency lineups. Save grew 82.24→116.41→151.27 MB and RSS 602.2→607.5→611.5 MB. The longer 20-season performance gate remains FAIL/UNPROVEN; economy/ownership/AI scaling is the recorded risk. |
