...
| Performance                   | FAIL_PERFORMANCE | The scaling pass reduced the comparable three-season run from 987.46s to 797.22s: S1/S2/S3 were 161.91s/233.78s/401.54s, with 0 structural shortages and 0 emergency lineups. Save grew 82.25→116.42→151.29 MB and RSS was 461.0→470.1→565.8 MB. The longer 20-season performance gate remains FAIL/UNPROVEN.                                                                                                                            |
