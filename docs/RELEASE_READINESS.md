...
| Performance                   | FAIL_PERFORMANCE | The accepted `76710af` reference is 797.22s cumulative for three seasons. Targeted procurement profiling found all-history order/offer reconstruction in AI planning; indexed aggregate lookup reduced the instrumented comparable run to 492.09s cumulative, with correctness passing. A clean 20-season performance gate remains unproven.                                                                                             |
