...
| Performance                   | FAIL_PERFORMANCE | One fresh full-production Season-1 revalidation completed in 239.54s elapsed (851 played matches, 82.15 MB save, 578.5 MB peak RSS), 48.5% faster than the 465.3s baseline after migration 85. The strict harness still failed on 2 position-shortage cases (prior baseline: 1); no gameplay change was made.                                                                                                                                 |
