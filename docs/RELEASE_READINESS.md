...
| Performance                   | FAIL_PERFORMANCE | The accepted `76710af` result remains 797.22s cumulative for three seasons (S1/S2/S3 161.91s/233.78s/401.54s). A follow-up referee-filter experiment was reverted because the comparable validation did not reproduce a gain: 986.64s cumulative (220.14s/282.26s/484.24s), with correctness still passing. The 20-season performance gate remains FAIL/UNPROVEN.                                                                        |
