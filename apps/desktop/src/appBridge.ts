...
const bindCommands = (call: CommandCaller): DesktopRuntimeApi => ({
  ...
  getClubExecutiveOverview: (clubId?: EntityId) =>
    call<ExecutiveRoleReadModel[]>("getClubExecutiveOverview", { clubId }),
  ...
  getPlayerPathway: (playerId: EntityId) => call<PlayerPathway>("getPlayerPathway", { playerId }),
  getStoryThreads: () => call<StoryThread[]>("getStoryThreads"),
  getStoryDetail: (eventId: EntityId) => call<StoryDetail>("getStoryDetail", { eventId }),
  ...
  ) => call("counterInvestorBid", { offerId, terms }),
  withdrawInvestorBidResponse: (offerId: EntityId) =>
    call("withdrawInvestorBidResponse", { offerId }),
  acknowledgeBoardOppositionForInvestorBid: (offerId: EntityId) =>
    call("acknowledgeBoardOppositionForInvestorBid", { offerId }),
